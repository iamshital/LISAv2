# Contributing to Linux Integration Services Automation (LISA), version 2
First, thank you for contributing to LISAv2 repository!

## Basics
If you would like to become an active contributor to this project, please follow the instructions provided in [LISAv2 Documentation](https://github.com/LIS/LISAv2/tree/master/Documents).
...
You can find all of the pull requests that have been opened in the [Pull Request](https://github.com/LIS/LISAv2/pulls) section of the repository.

To open your own pull request, click [here](https://github.com/LIS/LISAv2/compare). When creating a pull request, keep the following in mind:
...
<!-- - The SLA for reviewing pull requests is **two business days** for minor changes, or **up to 5 business days** for bigger changes -->
...
- Pull request must be tested on multiple Linux distributions to ensure functionality on various environments.
- Test results must be included to demonstrate the functionality.